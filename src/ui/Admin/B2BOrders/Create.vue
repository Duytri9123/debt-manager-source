...
const tax         = computed(() => Math.round(subtotal.value * (form.tax_rate / 100)))
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Nhập thông tin đơn hàng kinh doanh</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Thuế suất VAT</label>
                            <select v-model.number="form.tax_rate"
                                class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                <option :value="0">Không có thuế (0%)</option>
                        ...
                        <table class="w-full text-xs">
                            <thead class="bg-yellow-50 border-b border-yellow-200 sticky top-0">
                                <tr>
                                    ...
                                    <th class="px-2 py-2 text-left font-semibold text-gray-700 w-6">TT</th>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <tr v-for="(item, idx) in form.items" :key="item._key"
                                    ...
                                    <td class="px-2 py-1.5 text-gray-300 cursor-grab">
                                    ...
                                    <td class="px-2 py-1.5">
                                        <input v-model="item.unit" placeholder="Mét/Cái"
                                            class="w-full rounded border border-gray-200 px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-indigo-400" />
                                    </td>
                                    <td class="px-2 py-1.5">
                                    ...
                                    <td class="px-2 py-1.5 text-right font-semibold text-gray-800">
                                        {{ fmt(item.line_total) }}
                                    </td>
                                    <td class="px-2 py-1.5">
                                        <input v-model="item.note" placeholder="Ghi chú"
                                            class="w-full rounded border border-gray-200 px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-indigo-400" />
                                    </td>
                                    ...
                                    <td class="px-2 py-1.5 text-right text-orange-600 bg-orange-50/30 font-medium">
                                        {{ fmt(item.business_pct) }}
                                    </td>
                                    ...
                                    <td class="px-2 py-1.5 text-right font-semibold text-orange-700 bg-orange-50/30">
                            ...
                            <tfoot class="border-t-2 border-gray-300 bg-gray-50">
                                ...
                                <tr>
                                    <td colspan="8" class="px-3 py-2 text-right text-gray-500 text-xs">Thuế GTGT {{ form.tax_rate }}%:</td>

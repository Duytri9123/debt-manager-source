...
import { ArrowLeft, Plus, Trash2, Search, Package, GripVertical } from 'lucide-vue-next'
...
// ── Restore items từ bundle ───────────────────────────────────────────────────
const restoredItems = (props.bundle.items ?? []).map((item, i) => ({
    product_id:         item.product_id,
    product_variant_id: item.product_variant_id,
    product_name:       item.product?.name ?? '—',
    product_variants:   item.product?.variants ?? [],
    variant_label:      getVariantLabelFromItem(item),
...
function getVariantLabelFromItem(item) {
...
function lineTotal(item) { return getVariantPrice(item) * item.quantity }
...
function submit() {
    ...
    form.transform(() => payload).put(`/admin/product-bundles/${props.bundle.id}`)
}
</script>
    ...
    <AdminLayout>
        <div class="space-y-5 max-w-5xl">
            ...
            <div class="flex items-center gap-3">
                <button @click="router.visit(`/admin/product-bundles/${bundle.id}`)"
                    class="p-2 rounded-lg hover:bg-gray-100 transition-colors">
                    <ArrowLeft :size="18" class="text-gray-600" />
                </button>
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Chỉnh sửa: {{ bundle.name }}</h1>
                    <p class="text-sm text-gray-500">Cập nhật thông tin và thành phần nhóm sản phẩm</p>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div class="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button type="button" @click="addItem" :disabled="!selectedProd"
                        ...
                        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                            ...
                            <div v-if="!form.items.length" class="text-center py-10 text-gray-400">
                                ...
                                <p class="text-sm">Chưa có thành phần nào.</p>
                            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <button type="button" @click="router.visit(`/admin/product-bundles/${bundle.id}`)"

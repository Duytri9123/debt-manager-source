...
const form = useForm({
    ...
    document_date: props.document.document_date ?? new Date().toISOString().split('T')[0],
    status: props.document.status ?? 'draft',
    content: props.document.content ?? '',
    notes: props.document.notes ?? '',
    items: props.document.items?.length
        ...
        : [{ product_id: null, product_name: '', unit: '', expected_quantity: 0, actual_quantity: 0, notes: '' }],
})
...
function submit() {
    form.put('/admin/documents/' + props.document.id)
}
</script>
    ...
    <AdminLayout>
        <div class="space-y-6">
            ...
            <div class="flex items-center gap-3">
                <button @click="router.visit('/admin/documents/' + document.id)" class="text-gray-500 hover:text-gray-700 text-sm">← Quay lại</button>
                <h1 class="text-xl font-bold text-gray-900">Chỉnh sửa biên bản</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex gap-3 justify-end">
                    <button type="button" @click="router.visit('/admin/documents/' + document.id)"

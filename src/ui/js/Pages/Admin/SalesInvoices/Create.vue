...
const form = useForm({
    ...
    status: 'draft',
    notes: '',
    items: [{ product_id: null, product_name: '', unit: '', quantity: 1, unit_price: 0, tax_rate: 0, discount_rate: 0 }],
})
...
function submit() {
    form.post('/admin/sales-invoices')
}
</script>
    ...
    <AdminLayout>
        <div class="space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-xl font-bold text-gray-900">Tạo hóa đơn bán hàng</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex gap-3 justify-end">
                    <button type="button" @click="router.visit('/admin/sales-invoices')"

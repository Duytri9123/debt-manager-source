    ...
    <AdminLayout>
        <div class="space-y-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-xl font-bold text-gray-900">Tạo tạm ứng</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex gap-3 justify-end">
                    <button type="button" @click="router.visit('/admin/advances')"
                    ...
                    <button type="submit" :disabled="form.processing"
                        ...
                        {{ form.processing ? 'Đang lưu...' : 'Tạo tạm ứng' }}
                    </button>
                </div>
            </form>
        </div>
